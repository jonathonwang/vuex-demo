...
describe('Actions', function () {
  ...
  it('createNewTask', function (done) {
    ...
    testAction(actions.createNewTask, [state.newTask], state, [{ name: 'CREATE_TASK', payload: [] }, { name: 'CLEAR_NEW_TASK', payload: [] }, { name: 'SHOW_ALERT', payload: ['success', 'Task \"Hello World\" Successfully Created'] }], done);
  });
  ...
  it('createNewTask No-Title', function (done) {
    ...
    testAction(actions.createNewTask, [state.newTask], state, [{ name: 'SHOW_ALERT', payload: ['danger', 'New Task Cannot Be Empty'] }], done);
  });
  ...
  it('createNewTask 2 Characters', function (done) {
    ...
    testAction(actions.createNewTask, [state.newTask], state, [{ name: 'SHOW_ALERT', payload: ['danger', 'New Task Must Be At Least 3 Characters Long'] }], done);
  });
  ...
  it('hideAlert', function (done) {
    ...
    testAction(actions.hideAlert, [], state, [{ name: 'HIDE_ALERT', payload: [] }], done);
  });
  ...
  it('updateNewTask', function (done) {
    ...
    testAction(actions.updateNewTask, [newTask], state, [{ name: 'UPDATE_NEW_TASK', payload: ['Hello World'] }], done);
  });
  ...
  it('deleteTask', function (done) {
    ...
    testAction(actions.deleteTask, [taskToDelete], state, [{ name: 'DELETE_TASK', payload: [{ title: 'Hello World', status: 0 }] }, { name: 'SHOW_ALERT', payload: ['info', 'Task \"Hello World\" Successfully Deleted'] }], done);
  });
  ...
  it('toggleTaskStatus Complete', function (done) {
    ...
    testAction(actions.toggleTaskStatus, [taskToToggle], state, [{ name: 'COMPLETE_TASK', payload: [{ title: 'Hello World', status: 0 }] }], done);
  });
  ...
  it('toggleTaskStatus Incomplete', function (done) {
    ...
    testAction(actions.toggleTaskStatus, [taskToToggle], state, [{ name: 'UNCOMPLETE_TASK', payload: [{ title: 'Hello World', status: 1 }] }], done);
  });
  ...
  it('clearCompletedTasks', function (done) {
    ...
    testAction(actions.clearCompletedTasks, [completedTasksToClear], state, [{ name: 'CLEAR_COMPLETED_TASKS', payload: [[{ status: 1, title: 'Hello World1' }, { status: 1, title: 'Hello World2' }, { status: 1, title: 'Hello World3' }]] }, { name: 'SHOW_ALERT', payload: ['info', '3 Completed Tasks Successfully Deleted'] }], done);
  });
});
...
var SHOW_ALERT = _Alert.mutations.SHOW_ALERT;
var HIDE_ALERT = _Alert.mutations.HIDE_ALERT;
...
var _Task = require('../../vuex/modules/Task');
...
// destructure assign mutations
var CREATE_TASK = _Task.mutations.CREATE_TASK;
var UPDATE_NEW_TASK = _Task.mutations.UPDATE_NEW_TASK;
var CLEAR_NEW_TASK = _Task.mutations.CLEAR_NEW_TASK;
var DELETE_TASK = _Task.mutations.DELETE_TASK;
var COMPLETE_TASK = _Task.mutations.COMPLETE_TASK;
var UNCOMPLETE_TASK = _Task.mutations.UNCOMPLETE_TASK;
var CLEAR_COMPLETED_TASKS = _Task.mutations.CLEAR_COMPLETED_TASKS;
...
}), _defineProperty(_mutations, _mutationTypes.HIDE_ALERT, function (state) {
...
}), _defineProperty(_mutations, _mutationTypes.CLEAR_NEW_TASK, function (state) {
  state.newTask = '';
}), _defineProperty(_mutations, _mutationTypes.DELETE_TASK, function (state, task) {
  state.tasks.$remove(task);
}), _defineProperty(_mutations, _mutationTypes.COMPLETE_TASK, function (state, task) {
  task.status = 1;
}), _defineProperty(_mutations, _mutationTypes.UNCOMPLETE_TASK, function (state, task) {
  task.status = 0;
}), _defineProperty(_mutations, _mutationTypes.CLEAR_COMPLETED_TASKS, function (state, completedTasks) {
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  var _iteratorError = undefined;

  try {
    for (var _iterator = completedTasks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var CLEAR_NEW_TASK = exports.CLEAR_NEW_TASK = 'CLEAR_NEW_TASK';
var UPDATE_NEW_TASK = exports.UPDATE_NEW_TASK = 'UPDATE_NEW_TASK';
var DELETE_TASK = exports.DELETE_TASK = 'DELETE_TASK';
var COMPLETE_TASK = exports.COMPLETE_TASK = 'COMPLETE_TASK';
var UNCOMPLETE_TASK = exports.UNCOMPLETE_TASK = 'UNCOMPLETE_TASK';
var CLEAR_COMPLETED_TASKS = exports.CLEAR_COMPLETED_TASKS = 'CLEAR_COMPLETED_TASKS';
// ALERT MUTATIONS
