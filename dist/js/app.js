...
exports.default = {
  vuex: {
    getters: {
      alertVisibility: function alertVisibility(state) {
        return state.Alert.alert.visibility;
      },
      alertMessage: function alertMessage(state) {
        return state.Alert.alert.message;
      },
      alertStatus: function alertStatus(state) {
        return state.Alert.alert.status;
      }
    },
    actions: actions
  }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/jonathonkosla/Documents/Builds/vuex-test/src/js/components/Alert.vue"
  if (!module.hot.data) {
...
},{"../vuex/actions":8,"vue":3,"vue-hot-reload-api":2}],6:[function(require,module,exports){
'use strict';
...
exports.default = {
  vuex: {
    getters: {
      ...
      newTask: function newTask(state) {
...
},{"../vuex/actions":8,"vue":3,"vue-hot-reload-api":2}],7:[function(require,module,exports){
'use strict';
...
var _FormGroup = require('./components/FormGroup.vue');
...
new _vue2.default({
  el: 'body',
  store: _store2.default, // Inject Store Into All Components
  components: { FormGroup: _FormGroup2.default, Alert: _Alert2.default }
});

},{"./components/Alert.vue":5,"./components/FormGroup.vue":6,"./vuex/store":12,"vue":3}],8:[function(require,module,exports){
'use strict';
...
},{"../mutation-types":11}],10:[function(require,module,exports){
'use strict';
...
},{"../mutation-types":11}],11:[function(require,module,exports){
'use strict';
...
var _Task = require('./modules/Task.js');

var _Task2 = _interopRequireDefault(_Task);

var _Alert = require('./modules/Alert.js');
...
},{"./modules/Alert.js":9,"./modules/Task.js":10,"vue":3,"vuex":4}]},{},[7]);
